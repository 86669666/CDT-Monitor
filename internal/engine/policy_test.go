...
func TestScheduledConsumptionUsesOvernightCycleSnapshot(t *testing.T) {
	...
	if err = st.Setup(ctx, domain.Config{
		...
		Accounts: []domain.Account{{AccessKeyID: "LTAI-OVERNIGHT", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-overnight", MaxTraffic: 200, ScheduleEnabled: true, StartTime: "08:00", StopTime: "00:34", DailyReport: &trueVal}},
	}); err != nil {
		t.Fatal(err)
	}
...
func TestScheduledConsumptionFallsBackWhenSnapshotIsMissing(t *testing.T) {
	...
	if err = st.Setup(ctx, domain.Config{
		...
		Accounts: []domain.Account{
			{AccessKeyID: "LTAI-SNAPSHOT", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-snapshot", MaxTraffic: 200, ScheduleEnabled: true, StartTime: "08:00", StopTime: "00:10"},
			{AccessKeyID: "LTAI-SNAPSHOT-2", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-snapshot-2", MaxTraffic: 200, ScheduleEnabled: true, StartTime: "08:00", StopTime: "00:10"},
		},
	}); err != nil {
		t.Fatal(err)
	}
	...
	stopOnly := accounts[1]
	stopOnly.TrafficUsed = 54.44
	stopOnly.ScheduleEnabled = true
	stopOnly.StartTime = "08:00"
	stopOnly.StopTime = "00:10"
...
func TestScheduledReportWaitsForStopMonitor(t *testing.T) {
	...
	cfg := domain.Config{
		...
		Accounts: []domain.Account{
			{AccessKeyID: "LTAI-SCHEDULED", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-scheduled", ScheduleEnabled: true, StartTime: "08:00", StopTime: "00:10"},
			{AccessKeyID: "LTAI-UNSCHEDULED", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-unscheduled", DailyReportTime: "00:10"},
		},
	}
...
func TestScheduledReportRecoversAfterStopSnapshot(t *testing.T) {
	...
	cfg := domain.Config{
		...
		ThresholdAction: "stop_and_notify", APIInterval: 600, Timezone: "Asia/Shanghai", EnableDailyReport: true,
		Accounts: []domain.Account{{
			AccessKeyID: "LTAI-RECOVERY", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-recovery",
...
func TestDailyReportGroupsOnlyUnscheduledAccountsAtSameTime(t *testing.T) {
	...
	if err = st.Setup(ctx, domain.Config{
		...
		ThresholdAction: "stop_and_notify", APIInterval: 600, Timezone: "Asia/Shanghai", EnableDailyReport: true,
		Accounts: []domain.Account{
			{AccessKeyID: "LTAI-GROUP-A", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "group-a", DailyReportTime: "22:00"},
			{AccessKeyID: "LTAI-GROUP-B", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "group-b", DailyReportTime: "22：00"},
			{AccessKeyID: "LTAI-LATER", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "later", DailyReportTime: "22:05"},
			{AccessKeyID: "LTAI-DISABLED", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "disabled", DailyReportTime: "22:00", DailyReport: &falseValue},
			{AccessKeyID: "LTAI-STOP-A", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "stop-a", ScheduleEnabled: true, StartTime: "08:00", StopTime: "22:00"},
			{AccessKeyID: "LTAI-STOP-B", MaxTraffic: 200, AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "stop-b", ScheduleEnabled: true, StartTime: "08:00", StopTime: "22:00"},
		},
	}); err != nil {
		t.Fatal(err)
	}
...
func TestGroupedDailyReportIncludesOnlySelectedAccounts(t *testing.T) {
	...
	if err = st.Setup(ctx, domain.Config{
		...
		Accounts: []domain.Account{
			{AccessKeyID: "LTAI-A", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-a", Remark: "分组甲", MaxTraffic: 100, DailyReportTime: "22:00"},
			{AccessKeyID: "LTAI-B", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-b", Remark: "分组乙", MaxTraffic: 100, DailyReportTime: "22:00"},
			{AccessKeyID: "LTAI-C", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-c", Remark: "其他时间", MaxTraffic: 100, DailyReportTime: "23:00"},
			{AccessKeyID: "LTAI-D", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-d", Remark: "定时关机", MaxTraffic: 100, ScheduleEnabled: true, StartTime: "08:00", StopTime: "22:00"},
		},
	}); err != nil {
		t.Fatal(err)
	}
...
func TestGroupedDailyReportKeepsQueuedMembershipAfterSettingsChange(t *testing.T) {
	...
	if err = st.Setup(ctx, domain.Config{
		...
		Notifications: domain.NotificationConfig{Webhook: domain.WebhookConfig{Enabled: true, URL: "https://webhook.example.com/test"}},
		Accounts: []domain.Account{
			{AccessKeyID: "LTAI-CHANGE-A", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-change-a", Remark: "保留实例", MaxTraffic: 100, DailyReportTime: "22:00"},
			{AccessKeyID: "LTAI-CHANGE-B", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-change-b", Remark: "关闭日报", MaxTraffic: 100, DailyReportTime: "22:00"},
			{AccessKeyID: "LTAI-CHANGE-C", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-change-c", Remark: "后来改时", MaxTraffic: 100, DailyReportTime: "23:00"},
		},
	}); err != nil {
		t.Fatal(err)
	}
...
func TestDailyReportTestPushUsesRolling24HourWindow(t *testing.T) {
	...
	cfg := domain.Config{
		...
		Notifications:     domain.NotificationConfig{Webhook: domain.WebhookConfig{Enabled: true, URL: "https://webhook.example.com/test"}},
		Accounts: []domain.Account{{
			AccessKeyID: "LTAI-TEST-WINDOW", AccessKeySecret: "secret", RegionID: "cn-hongkong", InstanceID: "i-test-window",
...
func TestDailyReportRefreshesTrafficBeforeCalculation(t *testing.T) {
	...
	cfg := domain.Config{
		...
		Accounts: []domain.Account{{
			AccessKeyID:     "LTAI-REPORT-REFRESH",
